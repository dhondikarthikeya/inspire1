...
{ src: "/images/wow7.png", alt: "Students performing culinary assessment", caption: "Skill Demonstration & Evaluation" },
  ...
  const [form, setForm] = useState<EnquiryForm>({ name: "", phone: "", course: "BHM" });
  ...
  () => [
    ...
    },
    {
      ...
      points: [
        ...
        "Eligibility: 10th / 12th / Degree / PG",
        "Service techniques",
  ...
  // Replace these paths with your real logo filenames in /public/images/placements/
  // ✅ Place this near other useMemo blocks inside Home()
type PlacementLogo = { src: string; alt: string };
...
const abroadPlacements = useMemo(
      ...
      <div className="home__container">
        ...
        <section className="hero" aria-label="Hero">
          <div className="hero__grid">
            <div className="hero__copy hero__copy--premium" data-reveal>
  ...
  <p className="hero__sub">
    {SITE.name} in {SITE.location} is dedicated to shaping confident hospitality
    professionals through a balance of academic learning, hands-on training,
  ...
  <div className="heroDescription">
    <p>
      Our programs are designed to prepare students for careers in hotels,
      resorts, airlines, tourism, and service industries by focusing on
      practical skills, professional grooming, and workplace readiness.
    </p>

    <p>
      With experienced faculty, structured practical sessions, and student-first
      guidance, we help learners build confidence, discipline, and a strong
      foundation for long-term career growth in hospitality.
    </p>
  </div>
  ...
  <div className="miniNote__content">
    ...
    <span>
      Simple admission process • Personal guidance • Career-focused learning
    </span>
  </div>
</div>
</div>
            ...
            {/* ENQUIRY CARD */}
            <aside className="hero__card" data-reveal aria-label="Quick enquiry form">
...
">Diploma In F&B Service & Housekeeping
      ...
      {/* WHY SECTION */}
      <section className="whySection whySection--full" aria-label="Why students choose hospitality" data-reveal>
        <div className="whySection__inner whySection__inner--full">
          ...
          <div className="whyCards">
            {highlightCards.map((c) => (
              <article key={c.title} className="whyCard">
          ...
          <aside className="gainBox" aria-label="What students gain">
            ...
            <div className="gainGrid">
              {outcomes.map((o) => (
                <div key={o.k} className="gainTile">
      ...
      <div className="home__container">
        {/* COURSES */}
        <section id={coursesSectionId} className="section coursesSection">
...
/>
       ...
       {/* ===================== PLACEMENTS SECTION ===================== */}
<section
  className="placementsFull"
  aria-label="Placements and career support"
  data-reveal
>
  <div className="placementsBox">
    ...
    {/* Stats */}
    <div
      className="placementsStats placementsStats--center"
    ...
    {/* Company Logos */}
    <div
      className="placementsCompaniesBox"
      aria-label="Placement partners"
    >
      <div className="placementsLogoGrid">
        {placementLogos.map((logo) => (
          <div key={logo.alt} className="placementsLogoCard">
            <img
              className="placementsLogoImg"
              src={logo.src}
              alt={logo.alt}
              loading="lazy"
            />
...
<section
  className="placementsFull placementsProudSection"
  aria-label="What made INSPIRE proud"
  data-reveal
>
  <div className="placementsBox">
    ...
    <p className="placementsAbroad__desc placementsSub--center">
      Students have been to Abroad placement through INSPIRE (2025)
    </p>

    <div className="placementsAbroad__grid">
      {abroadPlacements.map((s) => (
        <article key={s.name} className="whyCard placementsAbroadCard">
          <div className="whyCard__media placementsAbroadCard__media">
            <img src={s.img} alt={s.name} loading="lazy" />
          </div>

          <div className="whyCard__body placementsAbroadCard__body">
            <h3 className="whyCard__title placementsAbroadCard__title">
              {s.name}
            </h3>
            <p className="whyCard__text placementsAbroadCard__text">
              {s.company}
            </p>
...
{/* ===================== END PROUD / ABROAD SECTION ===================== */}
       ...
       {/* FAQ */}
{/* ================= FAQ SECTION ================= */}
<section className="section faqSection" aria-label="Frequently asked questions" data-reveal>

  {/* Heading OUTSIDE grid */}
  <div className="section__head faqHead">
    <h2 className="section__title">
      <span className="handUnderline">FAQ</span></h2>
          ...
          return (
            <div key={item.q} className={`faqItem ${open ? "is-open" : ""}`}>
              ...
              <div
                ...
                className={`faqPanel ${open ? "is-open" : ""}`}
              >
    ...
    <aside className="faqRight" aria-label="Student support visual">
      <div className="faqPhotoCard">
        ...
        <div className="faqPhotoCard__content">
          ...
          <h3 className="faqPhotoCard__title">
            Talk to our admission team
          </h3>
          <p className="faqPhotoCard__text">
            Get course details, eligibility, fees, and guidance in minutes.
          </p>
...
{/* ADMISSION ENQUIRY (below FAQ) */}
{/* ADMISSION ENQUIRY (below FAQ) */}
<section className="section admissionEnquiry" aria-label="Admission enquiry" data-reveal>
  <div className="admissionEnquiry__wrap">
    ...
    <div className="admissionEnquiry__head">
      ...
      <p className="admissionEnquiry__sub">
    ...
    <div className="admissionEnquiry__content">
      ...
      {/* RIGHT: FORM */}
      <aside className="admissionEnquiry__card" aria-label="Admission enquiry form">
...
">Diploma In F&B Service & Housekeeping
      ...
      {/* <div className="stickyCta" role="region" aria-label="Quick actions">
        ...
        <a className="stickyCta__btn stickyCta__btn--gold" href={quickWaHref} target="_blank" rel="noreferrer">
          WhatsApp
        </a>
